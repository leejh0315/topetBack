...
//	public Long create(@RequestParam(value = "photos", required = false) List<MultipartFile> photos,
//			@RequestParam(value = "title") String title, @RequestParam(value = "content") String content,
//			@RequestParam(value = "category") String category, @RequestParam(value = "hashtag") String hashtag,
//			@RequestParam(value = "animal") String animal) throws Exception {
//
//		System.out.println("Received data: " + title + ", " + content + ", " + category + ", " + hashtag + ", " + animal
//				+ ", " + photos);
//
//		CommunityVo requseVo = CommunityVo.builder().title(title).content(content).category(category).hashtag(hashtag)
//				.animal(animal).build();
//
...
//	public String boardList(Model model, @PathVariable("animal") String animal,
